...
@property (retain) NSString* jjfl2;
@end
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasJjfl2) {
    [output writeString:8 value:self.jjfl2];
  }
...
- (int32_t) serializedSize {
  ...
  if (self.hasJjfl2) {
    size += computeStringSize(8, self.jjfl2);
  }
...
- (FundBasic_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 66: {
        [self setJjfl2:[input readString]];
        break;
      }
    }
  }
