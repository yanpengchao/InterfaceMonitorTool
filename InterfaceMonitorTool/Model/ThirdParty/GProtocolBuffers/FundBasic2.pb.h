...
@interface FundBasic2Root : NSObject {
}
+ (PBExtensionRegistry*) extensionRegistry;
+ (void) registerAllExtensions:(PBMutableExtensionRegistry*) registry;
@end

@interface FundBasic : PBGeneratedMessage {
@private
  BOOL hasJjfl_:1;
  BOOL hasJjdm_:1;
  BOOL hasJjpy_:1;
...
@interface FundBasic_Builder : PBGeneratedMessage_Builder {
@private
  FundBasic* result;
}
...
- (BOOL) hasJjfl2;
- (NSString*) jjfl2;
- (FundBasic_Builder*) setJjfl2:(NSString*) value;
- (FundBasic_Builder*) clearJjfl2;
@end
