...
@class FundBasic;
@class FundBasicInfo;
@class FundBasicInfo_Builder;
@class FundBasic_Builder;

@interface FundBasicInfoRoot : NSObject {
}
+ (PBExtensionRegistry*) extensionRegistry;
+ (void) registerAllExtensions:(PBMutableExtensionRegistry*) registry;
@end

@interface FundBasicInfo : PBGeneratedMessage {
@private
...
@interface FundBasicInfo_Builder : PBGeneratedMessage_Builder {
@private
  FundBasicInfo* result;
}
